...
on servers) and provides many advantages such as autocompletion, inspecting objects, integration with version control, and project management.
...
The [RStudio IDE cheatsheet](http://www.rstudio.com/wp-content/uploads/2016/01/rstudio-IDE-cheatsheet.pdf) is particularly helpful when working with RStudio.
...
> current line, you can 1. click on the **Run** toolbar button just above the editor panel,
> or 2. select the **Code -> Run Lines** menu item, or 3. hit **Ctrl-Enter** in Windows
> or Linux or **Cmd-Enter** on OS X. (This shortcut can also be seen by hovering
> the mouse over the button). To run a block of code, highlight the block of code before doing one of the steps above.
> If you have modified a line of code within a block of code you have just run,
> there is no need to reselect the section and run it. You can use the **Code -> Re-run Previous** menu item. This will run the previous code block
...
you used the interpreter included with R, which is what you get when you type `R` in the command line.
